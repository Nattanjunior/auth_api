...
const config = {
  "generator": {
    ...
    "output": {
      "value": "C:\\Users\\fnata\\OneDrive\\Documentos\\Backend\\nestjs-auth\\generated\\prisma",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "previewFeatures": [],
    "sourceFilePath": "C:\\Users\\fnata\\OneDrive\\Documentos\\Backend\\nestjs-auth\\prisma\\schema.prisma",
    "isCustomOutput": true
  },
  "relativeEnvPaths": {
    "rootEnvPath": "../../.env",
  ...
  "inlineDatasources": {
    "db": {
      "url": {
        ...
        "value": "postgresql://postgres:postgres@localhost:5432/nest-db?schema=public"
      }
    }
  },
  "inlineSchema": "// This is your Prisma schema file,\n// learn more about it in the docs: https://pris.ly/d/prisma-schema\n\n// Looking for ways to speed up your queries, or scale easily with your serverless or edge functions?\n// Try Prisma Accelerate: https://pris.ly/cli/accelerate-init\n\ngenerator client {\n  provider = \"prisma-client-js\"\n  output   = \"../generated/prisma\"\n}\n\ndatasource db {\n  provider = \"postgresql\"\n  url      = env(\"DATABASE_URL\")\n}\n\nenum Roles {\n  ADMIN\n  EDITOR\n  WRITER\n  READER\n}\n\nmodel User {\n  id        String   @id @default(cuid())\n  name      String\n  email     String   @unique\n  password  String\n  role      Roles    @default(READER)\n  createdAt DateTime @default(now())\n  updatedAt DateTime @default(now())\n}\n",
  "inlineSchemaHash": "de4b252bc87f453962e9ddf28fa3b8d6153d48514a29b92be0a0b62ffd9e5f0e",
  "copyEngine": true
}
